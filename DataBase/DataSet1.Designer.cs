...
namespace DataBase {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class tbl_contactDataTable : global::System.Data.TypedTableBase<tbl_contactRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public tbl_contactRow Addtbl_contactRow(int ContactID, string FirstName, string LastName, string ContactNo, string Address, string Gender) {
...
namespace DataBase.DataSet1TableAdapters {
    ...
    public partial class tbl_contactTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[tbl_contact] WHERE (([ContactID] = @Original_ContactID) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([ContactNo] = @Original_ContactNo) AND ([Address] = @Original_Address) AND ([Gender] = @Original_Gender))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[tbl_contact] ([ContactID], [FirstName], [LastName], [ContactNo], [Address], [Gender]) VALUES (@ContactID, @FirstName, @LastName, @ContactNo, @Address, @Gender);
SELECT ContactID, FirstName, LastName, ContactNo, Address, Gender FROM tbl_contact WHERE (ContactID = @ContactID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tbl_contact] SET [ContactID] = @ContactID, [FirstName] = @FirstName, [LastName] = @LastName, [ContactNo] = @ContactNo, [Address] = @Address, [Gender] = @Gender WHERE (([ContactID] = @Original_ContactID) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([ContactNo] = @Original_ContactNo) AND ([Address] = @Original_Address) AND ([Gender] = @Original_Gender));
SELECT ContactID, FirstName, LastName, ContactNo, Address, Gender FROM tbl_contact WHERE (ContactID = @ContactID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataBase.Properties.Settings.Default.EcontactConnectionString1;
        }
        ...
        public virtual int Fill(DataSet1.tbl_contactDataTable dataTable) {
        ...
        public virtual DataSet1.tbl_contactDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet1.tbl_contactDataTable dataTable = new DataSet1.tbl_contactDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet1.tbl_contactDataTable dataTable) {
        ...
        public virtual int Insert(int ContactID, string FirstName, string LastName, string ContactNo, string Address, string Gender) {
        ...
        public virtual int Update(int ContactID, string FirstName, string LastName, string ContactNo, string Address, string Gender, int Original_ContactID, string Original_FirstName, string Original_LastName, string Original_ContactNo, string Original_Address, string Original_Gender) {
        ...
        public virtual int Update(string FirstName, string LastName, string ContactNo, string Address, string Gender, int Original_ContactID, string Original_FirstName, string Original_LastName, string Original_ContactNo, string Original_Address, string Original_Gender) {
            return this.Update(Original_ContactID, FirstName, LastName, ContactNo, Address, Gender, Original_ContactID, Original_FirstName, Original_LastName, Original_ContactNo, Original_Address, Original_Gender);
        }
    }
